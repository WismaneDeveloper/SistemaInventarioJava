...
public class ventanaProductosVentana extends javax.swing.JFrame {

    List<Producto> listGlobal = new ArrayList<>();
    ProductoDAO dao = new ProductoDAO();
    private final registrarVenta window;

    public ventanaProductosVentana(registrarVenta window) {
        initComponents();
        this.window = window;
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
        ...
        producto.put("producto",table.getModel().getValueAt(fila, 2).toString().trim().toUpperCase());
        producto.put("descripcion", table.getModel().getValueAt(fila, 8).toString().trim());
        producto.put("precio",table.getModel().getValueAt(fila, 6).toString().trim());
        producto.put("disponible", table.getModel().getValueAt(fila,  5).toString().trim());
        window.setTextProducto(producto);
    ...
    private void TableModel(List<Producto> listProductos) {
        ...
        String columns[] = {"Id", "Codigo", "Nombre", "Marca", "Categoria", "Stock", "Precio", "Proveedor","Descripcion"};
        ...
        for (int i = 0; i < listProductos.size(); i++) {
            modelTable.addRow(new Object[]{
                ...
                listProductos.get(i).getDescripcion()
            });
