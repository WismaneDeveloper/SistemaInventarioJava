...
public class registrarCategoria extends javax.swing.JFrame {
    ...
    public registrarCategoria(registrarProducto ventana) {
        initComponents();
        this.ventana = ventana;
        setTitle("Registro de categorias");
        this.setLocationRelativeTo(null);
        this.setDefaultCloseOperation(registrarCategoria.DISPOSE_ON_CLOSE);
    ...
    private void buttonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSaveActionPerformed
        // TODO add your handling code here:
         if (txtDescription.getText().isEmpty()) {
            ...
            dataC.setDescripcion(description);
            saveDataC.registrarCategoria(dataC);
            String acctionUser = "El usuario ha registrado una nueva categoria";
            recordDescription(modelo, acctionUser);
            JOptionPane.showMessageDialog(rootPane, "La categoria se registro exitosamente!", "Categoria registrada.", JOptionPane.INFORMATION_MESSAGE);
            updateCombo();
        }
